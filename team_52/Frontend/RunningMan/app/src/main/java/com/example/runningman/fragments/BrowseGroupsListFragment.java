...
public class BrowseGroupsListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        BrowseGroupsListAdapter browseGroupsListAdapter = new BrowseGroupsListAdapter(listener);
        recyclerView.setAdapter(browseGroupsListAdapter);
