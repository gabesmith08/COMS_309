...
public class SpecificProfileGroupFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            JSONObject groupJSON = DataHolder.getInstance().getUserGroups().getJSONObject(getArguments().getInt(KEY_GROUP_INDEX));
        ...
        if (inGroup) {
            ...
            joinGroupButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        JSONObject groupJSON = (JSONObject) DataHolder.getInstance().getUserGroups().get(getArguments().getInt(KEY_GROUP_INDEX));
        ...
        try {
            JSONObject groupJSON = DataHolder.getInstance().getUserGroups().getJSONObject(index);
